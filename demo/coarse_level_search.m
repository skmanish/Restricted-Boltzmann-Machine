...
HiddenUnits = 800:-100:400;
learningRates = 0.05:0.02:0.11;
batchSizes = 200:-50:50;
Epochs = 300:-50:150;
Dropouts = 0.2:-0.1:0;
...
for dropout = Dropouts
    ...
    fprintf('For setting hidden = %d, lrate = %f, batchSize = %d, epochs = %d, Dropout = %f, misclassification error = %f\n',nHid, lRate, batchSize, epochs, dropout, classErr*100);
